...
proc create_root_design { parentCell } {
  ...
  set my_conuter_0 [ create_bd_cell -type ip -vlnv user.org:user:my_conuter:1.0 my_conuter_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_datamover_0_M_AXI_S2MM] [get_bd_intf_pins axi_datamover_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net my_conuter_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins my_conuter_0/M_AXIS]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_StreamCapture_0/S_AXI/S_AXI_reg] SEG_AXI_StreamCapture_0_S_AXI_reg
...
save_bd_design
make_wrapper -files [get_files "${origin_dir}/${project_dir}/${project_name}.srcs/sources_1/bd/${design_name}/${design_name}.bd"] -top
add_files -norecurse "${origin_dir}/${project_dir}/${project_name}.srcs/sources_1/bd/${design_name}/hdl/${design_name}_wrapper.v"
